    ...
    <table id="example" class="table table-dark table-striped table-bordered dt-responsive nowrap" width="100%">
        ...
        <tr>
            ...
            <?php
                ...
                $sql = "SELECT * FROM payment WHERE Address = '$id_acc' AND stat = 1 ORDER BY CurrDate DESC ";
                ...
                if ($result->num_rows > 0) 
                {
                    while($row = $result->fetch_assoc()) 
                    {
                        ...
                        $sql1 = "SELECT * FROM `records` WHERE ID = '".$row["Address"]."'";
                        ...
                        if ($result1->num_rows > 0) 
                        {
                            ...
                            {
						          echo "<td>" . $row1["Block"] ."-". $row1["Lot"]. "</td>";
                            }
                        }
